...
const RestaurantSchema = new Schema({
  ...
  cuisine: {
    type: [String],
    description:
      "Array of cuisine types offered by the restaurant (e.g., Italian, Indian)",
  },
    ...
    type: {
      ...
      geo: {
        ...
        coordinates: {
          type: [Number],
          description:
            "Array of longitude and latitude for restaurant location",
        },
      },
    },
    required: true,
  ...
  highlights: {
    type: [String],
    description:
      "Array of special features or highlights (e.g., 'Buffet', 'Outdoor Seating')",
  },
